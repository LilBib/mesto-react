...
function EditProfilePopup (props) {
    ...
    return (
        ...
        >
            <input id="profile-name" name="name" required minLength="2" maxLength="40" placeholder="Ваш никнейм" type="text" className="form__item form__item_section_name" value={name || ""} onChange={handleNameChange} />
